                ...
                <form class="theme-form" name="addForm" id="addForm">
                    ...
                    <div class="card-body pt-0">
                        ...
                        <div class="mb-3 row">
                            ...
                            <!-- Department Dropdown -->
                            <div class="col-md-4 mt-3" id="departmentContainer" style="display:none;">
                                ...
                                <select class="js-example-basic-single col-sm-12" id="department_id" name="department_id">
                                    ...
                                    @endforeach
                                    <!-- Department options can be dynamically populated here -->
                                </select>
                                <span class="text-danger is-invalid role_err"></span>
                            </div>
...
<script>
    ...
    $('#role').on('change', function() {
        if ($(this).val() == '1') {
            $('#department_id').show();  // Show the hidden textbox
        } else {
            $('#department_id').hide();  // Hide the textbox
        }
    });
});
