                        ...
                        <div class="card-body">
                            <div class="mb-3 row">
                                <div class="col-md-4">
                                    ...
                                    <input class="form-control" id="departmentname" name="departmentname" type="text" placeholder="Enter Department Name">
                                    <span class="text-danger is-invalid department_err"></span>
                                </div>
                                <div class="col-md-4">
                                    <label class="col-form-label" for="departmentinitial">Department Initial <span class="text-danger">*</span></label>
                                    <input class="form-control" id="departmentinitial" name="departmentinitial" type="text" placeholder="Enter Department Initial">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body py-2">
                            ...
                            <div class="mb-3 row">
                                <div class="col-md-4">
                                    <label class="col-form-label" for="departmentname">Department Name <span class="text-danger">*</span></label>
                                    <input class="form-control" id="departmentname" name="departmentname" type="text" placeholder="Department Name">
                                    <span class="text-danger is-invalid name_err"></span>
                                </div>
                                <div class="col-md-4">
                                    <label class="col-form-label" for="departmentinitial">Department Initial <span class="text-danger">*</span></label>
                                    <input class="form-control" id="departmentinitial" name="departmentinitial" type="text" placeholder="Enter Department Initial">
                                    <span class="text-danger is-invalid departmentinitial_err"></span>
                                </div>
                            </div>
                            ...
                            <table id="buttons-datatables" class="table table-bordered nowrap align-middle" style="width:100%">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{$department->departmentinitial}}</td>
        ...
        $.ajax({
            ...
            success: function(data, textStatus, jqXHR) {
                ...
                if (!data.error)
                {
                    ...
                    $("#editForm input[name='departmentname']").val(data.department.departmentname);
                    $("#editForm input[name='departmentinitial']").val(data.department.departmentinitial);
                }
                else
                {
                    alert(data.error);
