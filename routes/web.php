...
Route::middleware(['auth', 'PreventBackHistory', 'firewall.all'])->group(function () {
    ...
    Route::resource('subdepartments', App\Http\Controllers\Admin\Masters\SubDepartmentController::class);
    Route::resource('deliverymode', App\Http\Controllers\Admin\Masters\DeliverymodeConroller::class);
    Route::resource('lettertype', App\Http\Controllers\Admin\Masters\LettertypeConroller::class);
    Route::resource('wards', App\Http\Controllers\Admin\Masters\WardController::class);
    Route::resource('vip', App\Http\Controllers\Admin\Masters\VipController::class);

    Route::resource('inwardfile', App\Http\Controllers\InwardOutward\InwardOutwardController::class);
    Route::resource('outwardfile', App\Http\Controllers\InwardOutward\OutwardController::class);

    Route::resource('Department_inwardoutward', App\Http\Controllers\InwardOutward\DepartmentinwardoutwardController::class);

    Route::patch('/outwardfile/incrementField/{id}', [App\Http\Controllers\InwardOutward\DepartmentinwardoutwardController::class, 'incrementField'])->name('outwardfile.incrementField');

    Route::get('acknowlege_list', [App\Http\Controllers\InwardOutward\DepartmentinwardoutwardController::class, 'acknowlege_list'])->name('acknowlege_list');
...
//  Route::post('save_inwardfile', [App\Http\Controllers\InwardOutward\InwardOutwardController::class, 'save_inwardfile'])->name('save_inwardfile');
